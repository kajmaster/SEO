...
- Read `references/ontruiming-local-seo.md` when writing about woningontruiming, ontruimingsdienst, ontruimingsbedrijf, bedrijfsontruiming, zorgkamerontruiming, spoedontruiming, bezemschoon opleveren, herstelwerk, inboedel afvoeren, vervuilde woning, or local pages such as "woningontruiming Groningen".
...
- For local service pages, the page answers timing, cost factors, process, proof/trust, area, practical tasks, and next step.
